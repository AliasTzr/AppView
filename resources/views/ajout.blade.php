        ...
        <div class="mt-5 container border border-2">
            <div class="row mt-5">
                <div class="col-md-8 border border-2 m-auto">
                    ...
                    @endif
                    <form class="mt-5" method="post" action="{{route('produits.addproduits')}}">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" style="resize: none" cols="30" rows="5" placeholder="Description du produit" class="form-control"></textarea>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="price">prix</label>
                                <input type="number" name="price" class="form-control" id="price" placeholder="Nom du produit">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <select id="inStock" name="inStock" class="form-control">
                                    <option value="t" selected>Oui</option>
